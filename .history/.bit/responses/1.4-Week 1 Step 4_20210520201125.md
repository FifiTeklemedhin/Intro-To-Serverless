...
Azure is Microsoft's spin on serverless! We will be using it for all of our projects, but other alternatives such as Google Cloud Platform and Amazon Web Services also exist.
